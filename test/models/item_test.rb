...
module ContentsCore
  class ItemTest < ActiveSupport::TestCase
    ...
    test 'should create an item' do
      ...
      assert_equal 3, block.items.count
    ...
    test 'should create a base item' do
      ...
      assert_equal Item.to_s, block.items.last.type
    ...
    test 'should create an array item' do
      ...
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemArray )
      assert_equal ItemArray.to_s, item.type
    ...
    test 'should create an array item (with many data types)' do
      @page.create_block :custom, name: 'a-block', schema: { my_array: :item_array }, conf: { options: { my_array: { data_type: :float, values: [ [ 'Price 1', 45.5 ], [ 'Price 2', 39.9 ] ] } } }
      item = Page.last.cc_blocks.last.items.find_by name: 'my_array'
      item.update_data 38.2
      assert item.is_a?( ItemArray )
      assert_equal ItemArray.to_s, item.type
      assert_equal 'array', item.class.type_name
    ...
    test 'should create a boolean item' do
      ...
      assert item.is_a?( ItemBoolean )
      assert_equal ItemBoolean.to_s, item.type
    ...
    test 'should create a datetime item' do
      ...
      item.save
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemDatetime )
      assert_equal ItemDatetime.to_s, item.type
    ...
    test 'should create a file item' do
      ...
      item.save
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemFile )
      assert_equal ItemFile.to_s, item.type
    ...
    test 'should create a float item' do
      ...
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemFloat )
      assert_equal ItemFloat.to_s, item.type
    ...
    test 'should create an integer item' do
      ...
      item.update_data 15
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemInteger )
      assert_equal ItemInteger.to_s, item.type
    ...
    test 'should create an object item' do
      ...
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemObject )
      assert_equal ItemObject.to_s, item.type
    ...
    test 'should create a string item' do
      ...
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemString )
      assert_equal ItemString.to_s, item.type
    ...
    test 'should create a text item' do
      ...
      item = Page.last.cc_blocks.last.items.find_by name: 'an-item'
      assert item.is_a?( ItemText )
      assert_equal ItemText.to_s, item.type
